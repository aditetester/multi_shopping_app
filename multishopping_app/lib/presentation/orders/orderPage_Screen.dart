...
import 'package:multishopping_app/presentation/orders/store/order.dart';
...
import 'package:multishopping_app/presentation/orders/widgets/order_detail_item.dart';
...
class _OrderPageScreenState extends ConsumerState<OrderPageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarView = AppBar(
      title: Text(AppLocalizations.of(context).translate("order_title")),
      actions: [
        BadgeView(
